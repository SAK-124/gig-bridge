-- Feature additions: messages (chat), disputes table, reviews table,
-- extended gig fields, extended profile fields.

-- 1) Messages (in-hire chat)
...
-- 6) Storage bucket for dispute evidence and chat attachments
