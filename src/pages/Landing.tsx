...
import { GraduationCap, Briefcase, ShieldCheck, BadgeCheck, Wallet, Send, FileCheck2, UserPlus, FileSearch, ListChecks, Users, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background bridge-pattern">
      ...
      <header className="container flex items-center justify-between py-5">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-foreground/80">
          ...
          <Link to="/gigs" className="hover:text-primary transition-colors">Find Gigs</Link>
      ...
      <section className="container grid lg:grid-cols-2 gap-12 items-center pt-8 pb-20 md:pt-16 md:pb-28">
        ...
        <div className="relative">
          ...
          <Card className="relative overflow-hidden rounded-2xl border-border/60 shadow-lift">
            <img src={hero} alt="Pakistani student working on a laptop with bridge illustration" width={1280} height={960} className="w-full h-auto" />
          </Card>
          <div className="absolute -bottom-4 left-6 bg-card border rounded-xl shadow-card p-3 flex items-center gap-3 animate-float">
            ...
            <div>
              ...
              <div className="text-sm font-semibold">Protected by Gig Bridge</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                ...
                <Card key={i} className="p-5 rounded-2xl border-border/60 shadow-card hover:shadow-lift transition-smooth bg-card">
      ...
      <section className="container py-16">
        <Card className="rounded-2xl bg-gradient-brand text-primary-foreground p-10 md:p-14 shadow-lift border-0">
          <div className="grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              <h3 className="font-display text-3xl md:text-4xl font-bold mb-2">Ready to start earning?</h3>
              <p className="opacity-90 text-primary-foreground/85">Join Gig Bridge today — it's free for students.</p>
            </div>
            <Button asChild size="lg" variant="secondary" className="rounded-full">
      ...
      <footer className="container py-10 border-t border-border/60 mt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
        <Logo />
